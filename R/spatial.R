...
#' Improvement Districts (BID) shapefile. Business Improvement District (BID)
#' and neighborhood boundaries were acquired from the City of Milwaukee
#' \href{GIS Services REST API}
...
# bids <- readOGR("Business_Improvement_Districts_(BID).kml", layer="BIDs")
# find/change the <NAME> tag in XML to find layer name
Business Improvement District (BID) and neighborhood boundaries were acquired
from the City of Milwaukee
[GIS Services REST API](http://maps.milwaukee.gov/ArcGIS/rest/services/planning/Special_Districts/MapServer).
