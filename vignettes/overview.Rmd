...
library(sp)
nad27 <- crimes.munged@proj4string
wgs84 <- mkeoutline@proj4string
mkeoutline@proj4string
mkeoutline <- spTransform(mkeoutline, nad27)
...
Using **ggmap** and a transformation of the coordinates to the Web Mercator 
projection, we can plot on a basemap for context:
```{r, message=FALSE, warning=TRUE}
library(ggmap)
h.wgs84 <- spTransform(h2015, wgs84) 
